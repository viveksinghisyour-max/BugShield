...
DEFAULT_KEY = "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"


def _get_api_key() -> str:
    key = settings.nvidia_api_key or os.getenv("NVIDIA_API_KEY") or os.getenv("GEMINI_API_KEY")
